function clickedLeaderboardButton() {
    axios.get('http://54.250.168.167:8005/premium/getusers')
...
function downloadFile(){
    ...
    axios.get('http://54.250.168.167:8005/premium/download',{ headers: {"Authorization": token}})
    .then(response=>{
...
function GettingDownloadedFiles(){
    axios.get('http://54.250.168.167:8005/premium/downloadedfilelist')
    .then(res=> {
