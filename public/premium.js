function clickedLeaderboardButton() {
    axios.get('http://localhost:8005/premium/getusers')
...
function downloadFile(){
    ...
    axios.get('http://localhost:8005/premium/download',{ headers: {"Authorization": token}})
    .then(response=>{
...
function GettingDownloadedFiles(){
    axios.get('http://localhost:8005/premium/downloadedfilelist')
    .then(res=> {
