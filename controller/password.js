...
exports.forgotpassword = (req, res, next) => {
    ...
    const resetUrl = `http://localhost:8000/password/forgotpassword/${resetId}`;

    console.log(`http://localhost:8000/password/forgotpassword/${resetId}`);
    ...
    tranEmailApi.sendTransacEmail({
        ...
        htmlContent: `
        <h1>Cules Coding</h1>
        <a href="http://localhost:8000/password/forgotpassword/${resetUrl}">Click this link to reset your password</a>`
    })
