...
exports.forgotpassword = (req, res, next) => {
    ...
    const resetUrl = `http://l43.206.254.205:8000/password/forgotpassword/${resetId}`;

    console.log(`http://l43.206.254.205:8000/password/forgotpassword/${resetId}`);
    ...
    tranEmailApi.sendTransacEmail({
        ...
        htmlContent: `
        <h1>Cules Coding</h1>
        <a href="http://l43.206.254.205:8000/password/forgotpassword/${resetUrl}">Click this link to reset your password</a>`
    })
